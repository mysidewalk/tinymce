...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_22gun1y7jj8vl9d0.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_22gun1y7jj8vl9d0.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_22gun1y7jj8vl9d0.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_dldmzeycjj8vl9dl = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_dldmzeycjj8vl9dl.browsers();
    var oses = $_dldmzeycjj8vl9dl.oses();
    var browser = $_ecjipwyajj8vl9da.detectBrowser(browsers, userAgent).fold($_cnkg7ay6jj8vl9cw.unknown, $_cnkg7ay6jj8vl9cw.nu);
    var os = $_ecjipwyajj8vl9da.detectOs(oses, userAgent).fold($_alx4rhy8jj8vl9d1.unknown, $_alx4rhy8jj8vl9d1.nu);
  ...
  var $_1brna9y5jj8vl9cv = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_1brna9y5jj8vl9cv.detect(userAgent);
  });
  var $_g9jqply3jj8vl9cq = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_as4x6iyljj8vl9fe.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_as4x6iyljj8vl9fe.ELEMENT);
  var isText = isType$1($_as4x6iyljj8vl9fe.TEXT);
  var isDocument = isType$1($_as4x6iyljj8vl9fe.DOCUMENT);
  var $_2r0q1xykjj8vl9fc = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_2r0q1xykjj8vl9fc.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_3softuysjj8vl9g5 = { toArray: toArray };
  ...
  var $_6izh3yvjj8vl9go = { getOrDie: getOrDie };

  var node = function () {
    var f = $_6izh3yvjj8vl9go.getOrDie('Node');
    return f;
  };
  ...
  var $_1xve6gyujj8vl9gn = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_as4x6iyljj8vl9fe.ELEMENT;
  var DOCUMENT = $_as4x6iyljj8vl9fe.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_1xve6gyujj8vl9gn.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_g9jqply3jj8vl9cq.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_8lkpsvytjj8vl9g6 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_e5ce6nyyjj8vl9gu.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_8lkpsvytjj8vl9g6.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_8lkpsvytjj8vl9g6.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_3softuysjj8vl9g5.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_3softuysjj8vl9g5.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_6rh4ykynjj8vl9fi.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_6rh4ykynjj8vl9fi.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_6rh4ykynjj8vl9fi.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_6rh4ykynjj8vl9fi.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_6i0cfymjj8vl9fg.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_6i0cfymjj8vl9fg.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_6i0cfymjj8vl9fg.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_6i0cfymjj8vl9fg.append(parent, x);
    });
  };
  var $_e6jvk7z0jj8vl9h6 = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_6rh4ykynjj8vl9fi.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_6rh4ykynjj8vl9fi.children(wrapper);
    if (children.length > 0)
      $_e6jvk7z0jj8vl9h6.before(wrapper, children);
    remove(wrapper);
  };
  var $_e498z7yzjj8vl9h2 = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_6i0cfymjj8vl9fg.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_6yidjdyhjj8vl9ep.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_e498z7yzjj8vl9h2.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_6rh4ykynjj8vl9fi.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_e498z7yzjj8vl9h2.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_6i0cfymjj8vl9fg.append(element, guiSystem.element());
    var children = $_6rh4ykynjj8vl9fi.children(guiSystem.element());
  ...
  var json = function () {
    return $_6izh3yvjj8vl9go.getOrDie('JSON');
  };
  ...
  var $_ckjc07zhjj8vl9kp = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_ckjc07zhjj8vl9kp.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_8lkpsvytjj8vl9g6.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_ckjc07zhjj8vl9kp.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_ckjc07zhjj8vl9kp.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_ckjc07zhjj8vl9kp.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_2r0q1xykjj8vl9fc.isElement(source) || !$_2r0q1xykjj8vl9fc.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_fyncaazwjj8vl9o8 = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get,
  ...
  var read$1 = function (element, attr) {
    var value = $_fyncaazwjj8vl9o8.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_fyncaazwjj8vl9o8.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_fyncaazwjj8vl9o8.remove(element, attr);
    return false;
  };
  var $_7tx9nhzyjj8vl9om = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$1 = function (element) {
    return $_7tx9nhzyjj8vl9om.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_7tx9nhzyjj8vl9om.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_7tx9nhzyjj8vl9om.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_4hdmkuzxjj8vl9oj.supports(element))
      element.dom().classList.add(clazz);
    else
      $_4hdmkuzxjj8vl9oj.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_4hdmkuzxjj8vl9oj.supports(element) ? element.dom().classList : $_4hdmkuzxjj8vl9oj.get(element);
    if (classList.length === 0) {
      $_fyncaazwjj8vl9o8.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_4hdmkuzxjj8vl9oj.supports(element)) {
      ...
      $_4hdmkuzxjj8vl9oj.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_4hdmkuzxjj8vl9oj.supports(element) ? element.dom().classList.toggle(clazz) : $_4hdmkuzxjj8vl9oj.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_4hdmkuzxjj8vl9oj.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$1 = function (element, clazz) {
    return $_4hdmkuzxjj8vl9oj.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_es7262zujj8vl9o5 = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_es7262zujj8vl9o5.remove(element, removeCls);
    $_es7262zujj8vl9o5.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_es7262zujj8vl9o5.remove(component.element(), swapConfig.alpha());
    $_es7262zujj8vl9o5.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_es7262zujj8vl9o5.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_es7262zujj8vl9o5.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_6yidjdyhjj8vl9ep.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_8lkpsvytjj8vl9g6.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_czo5v8103jj8vl9p6.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_czo5v8103jj8vl9p6.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_czo5v8103jj8vl9p6.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_czo5v8103jj8vl9p6.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_czo5v8103jj8vl9p6.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_czo5v8103jj8vl9p6.descendant(scope, predicate).isSome();
  };
  var $_9p2rr2102jj8vl9p5 = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_6rh4ykynjj8vl9fi.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_6rh4ykynjj8vl9fi.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_9p2rr2102jj8vl9p5.closest(a, curry($_8lkpsvytjj8vl9g6.eq, element));
    });
  ...
  var search = function (element) {
    return active($_6rh4ykynjj8vl9fi.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_bff2dw101jj8vl9ow = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_g81c68107jj8vl9pv = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_6rh4ykynjj8vl9fi.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_6rh4ykynjj8vl9fi.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_eqcamk10gjj8vl9ra.fromHtml(content, docDom);
    $_e6jvk7z0jj8vl9h6.append(fragment, contentElements);
    $_e498z7yzjj8vl9h2.empty(element);
    $_6i0cfymjj8vl9fg.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_6i0cfymjj8vl9fg.append(container, clone);
    return get$2(container);
  };
  var $_1kfavx10fjj8vl9r8 = {
    get: get$2,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_fyncaazwjj8vl9o8.clone(original);
    $_fyncaazwjj8vl9o8.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_6rh4ykynjj8vl9fi.children(deep$1(original));
    $_e6jvk7z0jj8vl9h6.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_6i0cfymjj8vl9fg.before(original, nu);
    var children = $_6rh4ykynjj8vl9fi.children(original);
    $_e6jvk7z0jj8vl9h6.append(nu, children);
    $_e498z7yzjj8vl9h2.remove(original);
    return nu;
  };
  var $_4xdx8910hjj8vl9rf = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_4xdx8910hjj8vl9rf.shallow(element);
    return $_1kfavx10fjj8vl9r8.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_es7262zujj8vl9o5.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_es7262zujj8vl9o5.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_es7262zujj8vl9o5.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_es7262zujj8vl9o5.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_b5d1u4109jj8vl9q4.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_b5d1u4109jj8vl9q4.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_bff2dw101jj8vl9ow.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_bff2dw101jj8vl9ow.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_bff2dw101jj8vl9ow.hasFocus(component.element());
  };
  ...
  var $_c10ob2117jj8vl9xd = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_c10ob2117jj8vl9xd.isSupported(dom))
  ...
  var get$3 = function (element, property) {
    ...
    var v = r === '' && !$_6yidjdyhjj8vl9ep.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_c10ob2117jj8vl9xd.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_fyncaazwjj8vl9o8.has(element, 'style') && trim($_fyncaazwjj8vl9o8.get(element, 'style')) === '') {
      $_fyncaazwjj8vl9o8.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_fyncaazwjj8vl9o8.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_fyncaazwjj8vl9o8.remove : $_fyncaazwjj8vl9o8.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_c10ob2117jj8vl9xd.isSupported(sourceDom) && $_c10ob2117jj8vl9xd.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_bzt3vi116jj8vl9wy.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_bzt3vi116jj8vl9wy.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_6yidjdyhjj8vl9ep.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_bzt3vi116jj8vl9wy.set(element, 'max-height', absMax + 'px');
  };
  var $_7vibco115jj8vl9wt = {
    set: set$3,
    get: get$4,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_6yidjdyhjj8vl9ep.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_6rh4ykynjj8vl9fi.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_6rh4ykynjj8vl9fi.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_6rh4ykynjj8vl9fi.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_6rh4ykynjj8vl9fi.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_e5ce6nyyjj8vl9gu.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_bricac11ajj8vl9xn.ancestors(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_bricac11ajj8vl9xn.siblings(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_bricac11ajj8vl9xn.children(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_e5ce6nyyjj8vl9gu.all(selector, scope);
  };
  var $_dxlxi9119jj8vl9xl = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_e5ce6nyyjj8vl9gu.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_czo5v8103jj8vl9p6.ancestor(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_czo5v8103jj8vl9p6.sibling(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_czo5v8103jj8vl9p6.child(scope, function (e) {
      return $_e5ce6nyyjj8vl9gu.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_e5ce6nyyjj8vl9gu.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_e5ce6nyyjj8vl9gu.is, ancestor$2, scope, selector, isRoot);
  };
  var $_4whnay11bjj8vl9xr = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_dxlxi9119jj8vl9xl.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_es7262zujj8vl9o5.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_es7262zujj8vl9o5.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_es7262zujj8vl9o5.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_dxlxi9119jj8vl9xl.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_es7262zujj8vl9o5.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_4whnay11bjj8vl9xr.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_4whnay11bjj8vl9xr.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_es7262zujj8vl9o5.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_bff2dw101jj8vl9ow.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_4whnay11bjj8vl9xr.closest(element, sel);
      }).getOr(element);
      return $_7vibco115jj8vl9wt.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_dxlxi9119jj8vl9xl.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_4whnay11bjj8vl9xr.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_8lkpsvytjj8vl9g6.eq, tabstop));
  ...
  var inside = function (target) {
    return $_2r0q1xykjj8vl9fc.name(target) === 'input' && $_fyncaazwjj8vl9o8.get(target, 'type') !== 'radio' || $_2r0q1xykjj8vl9fc.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_bzt3vi116jj8vl9wy.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_5nia1p11tjj8vla19 = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_5nia1p11tjj8vla19.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_5nia1p11tjj8vla19.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_bzt3vi116jj8vl9wy.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_bzt3vi116jj8vl9wy.set, element, property, initial);
    var on = curry($_bzt3vi116jj8vl9wy.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_7tcjkf11vjj8vla1r.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_8lkpsvytjj8vl9g6.eq, current);
    var candidates = $_dxlxi9119jj8vl9xl.descendants(container, selector);
    var visible = filter(candidates, $_7tcjkf11vjj8vla1r.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_8lkpsvytjj8vl9g6.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_4whnay11bjj8vl9xr.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_4whnay11bjj8vl9xr.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_4whnay11bjj8vl9xr.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_4whnay11bjj8vl9xr.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_4whnay11bjj8vl9xr.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_bff2dw101jj8vl9ow.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_dxlxi9119jj8vl9xl.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_4whnay11bjj8vl9xr.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_dxlxi9119jj8vl9xl.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_dxlxi9119jj8vl9xl.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_4whnay11bjj8vl9xr.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_ckjc07zhjj8vl9kp.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_ckjc07zhjj8vl9kp.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_fyncaazwjj8vl9o8.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_fyncaazwjj8vl9o8.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_2r0q1xykjj8vl9fc.isElement(elem) ? $_fyncaazwjj8vl9o8.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_6rh4ykynjj8vl9fi.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_1kfavx10fjj8vl9r8.get(elem) };
    return deepMerge({
      tag: $_2r0q1xykjj8vl9fc.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_9v3uln10tjj8vl9un.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_9v3uln10tjj8vl9un.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_35gghw10sjj8vl9uf.format(command, function (button, status) {
  ...
  var isTouch = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch();
  ...
  var platform = $_g9jqply3jj8vl9cq.detect();
  ...
  var isTouch$2 = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_bzt3vi116jj8vl9wy.set(element, 'max-width', absMax + 'px');
  };
  var $_8ask0z130jj8vlah9 = {
    set: set$4,
    get: get$6,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_8ask0z130jj8vlah9.get(thumb.element()) / 2;
      $_bzt3vi116jj8vl9wy.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_bzt3vi116jj8vl9wy.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_ftme9310ujj8vl9uq.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_bzt3vi116jj8vl9wy.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_9v3uln10tjj8vl9un.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_35gghw10sjj8vl9uf.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_9v3uln10tjj8vl9un.resolve('slider-' + spec$$1.category + '-size-container'),
          $_9v3uln10tjj8vl9un.resolve('slider'),
          $_9v3uln10tjj8vl9un.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_9a1b8n133jj8vlahh = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_2r0q1xykjj8vl9fc.isElement(rawStart) ? Option.some(rawStart) : $_6rh4ykynjj8vl9fi.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_czo5v8103jj8vl9p6.closest(start, function (elem) {
        return $_bzt3vi116jj8vl9wy.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_bzt3vi116jj8vl9wy.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_bzt3vi116jj8vl9wy.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_8lkpsvytjj8vl9g6.eq(root, e);
    };
  ...
  var $_95q9qm134jj8vlahy = {
    candidates: constant(candidates),
    get: get$7,
    apply: apply$1
  };

  var sizes = $_95q9qm134jj8vlahy.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_9a1b8n133jj8vlahh.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_95q9qm134jj8vlahy.apply(editor, value);
      },
      getInitialValue: function () {
        return $_95q9qm134jj8vlahy.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_6izh3yvjj8vl9go.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_6izh3yvjj8vl9go.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_6izh3yvjj8vl9go.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_6izh3yvjj8vl9go.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_6izh3yvjj8vl9go.getOrDie('atob');
    return f(base64);
  };
  var $_1nskw913fjj8vlakg = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_1nskw913fjj8vlakg.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_34n7uv139jj8vlak7.create($_83n7es13ajj8vlak8.getWidth(image), $_83n7es13ajj8vlak8.getHeight(image));
      context = $_34n7uv139jj8vlak7.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_20h34e138jj8vlajm.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_20h34e138jj8vlajm.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_20h34e138jj8vlajm.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_20h34e138jj8vlajm.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_20h34e138jj8vlajm.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_20h34e138jj8vlajm.uriToBlob(uri));
  };
  var $_305nf7137jj8vlajf = {
  ...
  var addImage = function (editor, blob) {
    $_305nf7137jj8vlajf.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_avlnil13ijj8vlal7.get(link);
    var url = $_fyncaazwjj8vl9o8.get(link, 'href');
    var title = $_fyncaazwjj8vl9o8.get(link, 'title');
    var target = $_fyncaazwjj8vl9o8.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_fyncaazwjj8vl9o8.get(link, 'href');
    var prevText = $_avlnil13ijj8vlal7.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_fyncaazwjj8vl9o8.setAll(link, attrs);
        text.each(function (newText) {
          $_avlnil13ijj8vlal7.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_4whnay11bjj8vl9xr.closest(start, 'a');
  };
  var $_68z14713hjj8vlaks = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_g9jqply3jj8vl9cq.detect();
  ...
  var $_1uincb13jjj8vlal8 = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_ciurjr13tjj8vlao6.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_ciurjr13tjj8vlao6.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_ciurjr13tjj8vlao6.get(input.element());
            if (current !== data) {
              $_ciurjr13tjj8vlao6.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_9v3uln10tjj8vl9un.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_2r0q1xykjj8vl9fc.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_fyncaazwjj8vl9o8.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_fyncaazwjj8vl9o8.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_fyncaazwjj8vl9o8.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_fyncaazwjj8vl9o8.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_es7262zujj8vl9o5.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_es7262zujj8vl9o5.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_9v3uln10tjj8vl9un.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_4whnay11bjj8vl9xr.descendant(dialog.element(), '.' + $_9v3uln10tjj8vl9un.resolve('serialised-dialog-chain')).each(function (parent) {
        $_bzt3vi116jj8vl9wy.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_dxlxi9119jj8vl9xl.descendants(dialog.element(), '.' + $_9v3uln10tjj8vl9un.resolve('serialised-dialog-screen'));
      $_4whnay11bjj8vl9xr.descendant(dialog.element(), '.' + $_9v3uln10tjj8vl9un.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_bzt3vi116jj8vl9wy.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_8ask0z130jj8vlah9.get(screens[0]);
            $_bzt3vi116jj8vl9wy.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_dxlxi9119jj8vl9xl.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_35gghw10sjj8vl9uf.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_9v3uln10tjj8vl9un.resolve('dot-active'),
          itemClass: $_9v3uln10tjj8vl9un.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_2p8swa144jj8vlari.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_2p8swa144jj8vlari.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_2p8swa144jj8vlari.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_68z14713hjj8vlaks.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_68z14713hjj8vlaks.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_ftme9310ujj8vl9uq.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_1uincb13jjj8vlal8.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_68z14713hjj8vlaks.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_8lkpsvytjj8vl9g6.eq(originator, component.element()) && !$_8lkpsvytjj8vl9g6.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_ckjc07zhjj8vl9kp.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_ckjc07zhjj8vl9kp.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_ckjc07zhjj8vl9kp.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_ckjc07zhjj8vl9kp.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_ckjc07zhjj8vl9kp.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_es7262zujj8vl9o5.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_es7262zujj8vl9o5.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_es7262zujj8vl9o5.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_es7262zujj8vl9o5.has(element, clazz);
    });
  };
  ...
  var get$10 = function (element) {
    return $_4hdmkuzxjj8vl9oj.supports(element) ? getNative(element) : $_4hdmkuzxjj8vl9oj.get(element);
  };
  var $_f0u3g314mjj8vlazu = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_fyncaazwjj8vl9o8.setAll(subject, definition.attributes().getOr({}));
    $_f0u3g314mjj8vlazu.add(subject, definition.classes().getOr([]));
    $_bzt3vi116jj8vl9wy.setAll(subject, definition.styles().getOr({}));
    $_1kfavx10fjj8vl9r8.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_e6jvk7z0jj8vl9h6.append(subject, children);
    definition.value().each(function (value) {
      $_ciurjr13tjj8vlao6.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_6rh4ykynjj8vl9fi.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_ckjc07zhjj8vl9kp.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_bff2dw101jj8vl9ow.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_6rh4ykynjj8vl9fi.owner(container);
    var refocus = $_bff2dw101jj8vl9ow.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_8lkpsvytjj8vl9g6.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_czo5v8103jj8vl9p6.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_bff2dw101jj8vl9ow.active(ownerDoc).filter(function (newFocus) {
        return $_8lkpsvytjj8vl9g6.eq(newFocus, oldFocus);
      }).fold(function () {
        $_bff2dw101jj8vl9ow.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_6i0cfymjj8vl9fg.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_6i0cfymjj8vl9fg.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_8lkpsvytjj8vl9g6.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_es7262zujj8vl9o5.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_6yidjdyhjj8vl9ep.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_f0u3g314mjj8vlazu.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_f0u3g314mjj8vlazu.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_4whnay11bjj8vl9xr.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_es7262zujj8vl9o5.remove(comp.element(), t.transitionClass());
      $_fyncaazwjj8vl9o8.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_fyncaazwjj8vl9o8.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_fyncaazwjj8vl9o8.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_fyncaazwjj8vl9o8.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_fyncaazwjj8vl9o8.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_fyncaazwjj8vl9o8.has(comp.element(), transConfig.stateAttr()) && $_fyncaazwjj8vl9o8.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_fyncaazwjj8vl9o8.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_fyncaazwjj8vl9o8.has(comp.element(), transConfig.destinationAttr())) {
      $_fyncaazwjj8vl9o8.set(comp.element(), transConfig.stateAttr(), $_fyncaazwjj8vl9o8.get(comp.element(), transConfig.destinationAttr()));
      $_fyncaazwjj8vl9o8.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_es7262zujj8vl9o5.add(comp.element(), t.transitionClass());
      $_fyncaazwjj8vl9o8.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_fyncaazwjj8vl9o8.has(e, transConfig.stateAttr()) ? Option.some($_fyncaazwjj8vl9o8.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_9v3uln10tjj8vl9un.resolve('scrollable');
  var register = function (element) {
    $_es7262zujj8vl9o5.add(element, scrollable);
  };
  var deregister = function (element) {
    $_es7262zujj8vl9o5.remove(element, scrollable);
  };
  var $_2a3r8v159jj8vlb7h = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_9v3uln10tjj8vl9un.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_9v3uln10tjj8vl9un.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_35gghw10sjj8vl9uf.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_9v3uln10tjj8vl9un.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_9v3uln10tjj8vl9un.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_9v3uln10tjj8vl9un.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_bzt3vi116jj8vl9wy.set(component.element(), 'overflow-y', 'auto');
                $_bzt3vi116jj8vl9wy.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_2a3r8v159jj8vlb7h.register(component.element());
              }),
              runOnDetached(function (component) {
                $_bzt3vi116jj8vl9wy.remove(component.element(), 'overflow-y');
                $_bzt3vi116jj8vl9wy.remove(component.element(), '-webkit-overflow-scrolling');
                $_2a3r8v159jj8vlb7h.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_9v3uln10tjj8vl9un.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_8ask0z130jj8vlah9.get(container.element());
        $_8ask0z130jj8vlah9.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_8ask0z130jj8vlah9.get(container.element());
        var menu = $_4whnay11bjj8vl9xr.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_8ask0z130jj8vlah9.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_4whnay11bjj8vl9xr.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_9v3uln10tjj8vl9un.resolve('styles-background-menu'),
        menu: $_9v3uln10tjj8vl9un.resolve('styles-menu'),
        selectedMenu: $_9v3uln10tjj8vl9un.resolve('styles-selected-menu'),
        item: $_9v3uln10tjj8vl9un.resolve('styles-item'),
        selectedItem: $_9v3uln10tjj8vl9un.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_el5crs147jj8vlas6 = { sketch: sketch$9 };
  ...
  var $_3swjwo15ajj8vlb7o = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_3swjwo15ajj8vlb7o.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_el5crs147jj8vlas6.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_ftme9310ujj8vl9uq.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_ftme9310ujj8vl9uq.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_ftme9310ujj8vl9uq.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_91k2el12kjj8vlabs.sketch(realm, editor);
    };
    var styleFormats = $_15lsaw145jj8vlarl.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_15lsaw145jj8vlarl.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_ftme9310ujj8vl9uq.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_35gghw10sjj8vl9uf.receive($_b5d1u4109jj8vl9q4.orientationChanged(), Toggling.off),
            $_35gghw10sjj8vl9uf.receive($_b5d1u4109jj8vl9q4.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_ee3re115djj8vlb8i.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_ee3re115djj8vlb8i.capture(element, event, filter$1, handler);
  };
  var $_27i1sj15cjj8vlb8b = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_g9jqply3jj8vl9cq.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_27i1sj15cjj8vlb8b.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_8lkpsvytjj8vl9g6.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_27i1sj15cjj8vlb8b.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_27i1sj15cjj8vlb8b.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_ft8h2m15ijj8vlbai = { monitor: monitor$1 };

  var isAndroid6 = $_g9jqply3jj8vl9cq.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_ft8h2m15ijj8vlbai.monitor(editorApi);
    var outerDoc = $_6rh4ykynjj8vl9fi.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_8lkpsvytjj8vl9g6.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_bff2dw101jj8vl9ow.active(outerDoc).filter(function (input) {
        return $_2r0q1xykjj8vl9fc.name(input) === 'input';
    ...
    var listeners = [
      $_27i1sj15cjj8vlb8b.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_27i1sj15cjj8vlb8b.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_bff2dw101jj8vl9ow.blur(editorApi.body());
      }),
      ...
      $_27i1sj15cjj8vlb8b.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_27i1sj15cjj8vlb8b.bind(outerDoc, 'select', updateMargin),
      $_27i1sj15cjj8vlb8b.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_3b6i1915hjj8vlb9p = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_fyncaazwjj8vl9o8.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_blxqtt15mjj8vlbbq = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_2r0q1xykjj8vl9fc.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_2r0q1xykjj8vl9fc.name(element) === 'img' ? 1 : $_bdf08q15pjj8vlbcj.getOption(element).fold(function () {
      return $_6rh4ykynjj8vl9fi.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_bdf08q15pjj8vlbcj.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_2r0q1xykjj8vl9fc.name(elem));
  };
  var $_cah4sy15ojj8vlbce = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_8suqsh15sjj8vlbcz.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_6rh4ykynjj8vl9fi.defaultView(start);
  };
  var $_28ui0u15rjj8vlbcs = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_6rh4ykynjj8vl9fi.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_8lkpsvytjj8vl9g6.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_fyr2rg15ujj8vlbdf = {
    after: after$2,
  ...
  var $_5e6xty15vjj8vlbdh = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_bb5sez15wjj8vlbdq.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_bb5sez15wjj8vlbdq.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_bb5sez15wjj8vlbdq.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_bb5sez15wjj8vlbdq.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_bdf08q15pjj8vlbcj.get(textnode).length;
    var offset = $_azya72160jj8vlbfb.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_azya72160jj8vlbfb.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_debtxn161jj8vlbfe = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_6rh4ykynjj8vl9fi.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_azya72160jj8vlbfb.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_2r0q1xykjj8vl9fc.isText(node) ? $_debtxn161jj8vlbfe.locate : searchInChildren;
  ...
  var $_arlmhk15zjj8vlbez = { locate: locate$2 };

  var first$3 = function (element) {
    return $_czo5v8103jj8vl9p6.descendant(element, $_cah4sy15ojj8vlbce.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_cah4sy15ojj8vlbce.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_6rh4ykynjj8vl9fi.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_6f3fng163jj8vlbfv.first : $_6f3fng163jj8vlbfv.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_6rh4ykynjj8vl9fi.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_63ez3r162jj8vlbfp = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_arlmhk15zjj8vlbez.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_63ez3r162jj8vlbfp.search(doc, elem, x);
      };
      return $_6rh4ykynjj8vl9fi.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_28ui0u15rjj8vlbcs.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_bn70va15yjj8vlber = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_bb5sez15wjj8vlbdq.create(win);
    var self = $_e5ce6nyyjj8vl9gu.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_dxlxi9119jj8vl9xl.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_bb5sez15wjj8vlbdq.selectNodeContentsUsing(innerRange, elem);
      return $_bb5sez15wjj8vlbdq.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_2r0q1xykjj8vl9fc.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_24euia164jj8vlbg1 = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_2r0q1xykjj8vl9fc.name(element);
    if ('input' === name)
      return $_8suqsh15sjj8vlbcz.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_8suqsh15sjj8vlbcz.on(element, offset);
    else
      return offset === 0 ? $_8suqsh15sjj8vlbcz.before(element) : $_8suqsh15sjj8vlbcz.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_8suqsh15sjj8vlbcz.before, beforeSpecial, $_8suqsh15sjj8vlbcz.after);
    var finish = finishSitu.fold($_8suqsh15sjj8vlbcz.before, beforeSpecial, $_8suqsh15sjj8vlbcz.after);
    return $_28ui0u15rjj8vlbcs.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_28ui0u15rjj8vlbcs.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_bb5sez15wjj8vlbdq.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_24euia164jj8vlbg1.find(win, selection, selector);
  };
  var setRangeFromRelative = function (win, relative) {
    return $_c61v4c15xjj8vlbe6.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_8edgbl165jj8vlbg9.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_8edgbl165jj8vlbg9.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_28ui0u15rjj8vlbcs.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_bb5sez15wjj8vlbdq.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_8edgbl165jj8vlbg9.preprocess(selection);
    return $_c61v4c15xjj8vlbe6.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_28ui0u15rjj8vlbcs.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_fyr2rg15ujj8vlbdf.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_28ui0u15rjj8vlbcs.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_bb5sez15wjj8vlbdq.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$13 = function (win) {
    return getExact(win).map(function (range) {
      return $_28ui0u15rjj8vlbcs.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    return $_bb5sez15wjj8vlbdq.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    return $_bb5sez15wjj8vlbdq.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_bn70va15yjj8vlber.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    return $_bb5sez15wjj8vlbdq.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    return $_bb5sez15wjj8vlbdq.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    var fragment = $_5e6xty15vjj8vlbdh.fromElements(elements, win.document);
    $_bb5sez15wjj8vlbdq.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_c61v4c15xjj8vlbe6.asLtrRange(win, selection);
    $_bb5sez15wjj8vlbdq.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_8lkpsvytjj8vl9g6.eq(start, finish) && soffset === foffset;
  };
  var $_5bopfr15tjj8vlbd7 = {
    setExact: setExact,
    getExact: getExact,
    get: get$13,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_6rh4ykynjj8vl9fi.parent(start_1).bind(function (parent) {
        var selection = $_28ui0u15rjj8vlbcs.exact(start_1, range$$1.startOffset, parent, $_cah4sy15ojj8vlbce.getEnd(parent));
        var optRect = $_5bopfr15tjj8vlbd7.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_egs3mn15njj8vlbbu = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_bff2dw101jj8vl9ow.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_2r0q1xykjj8vl9fc.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_bff2dw101jj8vl9ow.active().each($_bff2dw101jj8vl9ow.blur);
      $_bff2dw101jj8vl9ow.focus(iBody);
    });
  };
  var $_3t5xiw166jj8vlbgf = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_9v3uln10tjj8vl9un.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_fyncaazwjj8vl9o8.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_blxqtt15mjj8vlbbq.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_egs3mn15njj8vlbbu.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_3t5xiw166jj8vlbgf.resume(cWin);
    };
    var onResize = $_27i1sj15cjj8vlb8b.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_fdkmhq15ljj8vlbb9 = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_5bopfr15tjj8vlbd7.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_27i1sj15cjj8vlb8b.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_5bopfr15tjj8vlbd7.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_5bopfr15tjj8vlbd7.get(win).bind(function (sel) {
                return $_5bopfr15tjj8vlbd7.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_5bopfr15tjj8vlbd7.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_5bopfr15tjj8vlbd7.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_g9jqply3jj8vl9cq.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_bzt3vi116jj8vl9wy.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_dxlxi9119jj8vl9xl.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_fyncaazwjj8vl9o8.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_fyncaazwjj8vl9o8.set(element, attr, backup);
          $_fyncaazwjj8vl9o8.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_dxlxi9119jj8vl9xl.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_dxlxi9119jj8vl9xl.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_fyncaazwjj8vl9o8.get(element, attr);
      if (restore !== 'no-styles') {
        $_fyncaazwjj8vl9o8.set(element, 'style', restore);
      } else {
        $_fyncaazwjj8vl9o8.remove(element, 'style');
      }
      $_fyncaazwjj8vl9o8.remove(element, attr);
  ...
  var $_3ibzw9168jj8vlbhr = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_4whnay11bjj8vl9xr.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_fyncaazwjj8vl9o8.set(meta, 'name', 'viewport');
      $_6i0cfymjj8vl9fg.append(head, meta);
      return meta;
    };
    var element = $_4whnay11bjj8vl9xr.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_fyncaazwjj8vl9o8.get(element, 'content');
    var maximize = function () {
      $_fyncaazwjj8vl9o8.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_fyncaazwjj8vl9o8.set(element, 'content', backup);
      } else {
        $_fyncaazwjj8vl9o8.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_4l5guc169jj8vlbia = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_4l5guc169jj8vlbia.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_es7262zujj8vl9o5.add(platform.container, $_9v3uln10tjj8vl9un.resolve('fullscreen-maximized'));
      $_es7262zujj8vl9o5.add(platform.container, $_9v3uln10tjj8vl9un.resolve('android-maximized'));
      meta.maximize();
      $_es7262zujj8vl9o5.add(platform.body, $_9v3uln10tjj8vl9un.resolve('android-scroll-reload'));
      androidApi.set($_fdkmhq15ljj8vlbb9.setup(platform.win, $_4t4pcn167jj8vlbh2.getWin(platform.editor).getOrDie('no')));
      $_4t4pcn167jj8vlbh2.getActiveApi(platform.editor).each(function (editorApi) {
        $_3ibzw9168jj8vlbhr.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_3b6i1915hjj8vlb9p.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_es7262zujj8vl9o5.remove(platform.container, $_9v3uln10tjj8vl9un.resolve('fullscreen-maximized'));
      $_es7262zujj8vl9o5.remove(platform.container, $_9v3uln10tjj8vl9un.resolve('android-maximized'));
      $_3ibzw9168jj8vlbhr.restoreStyles();
      $_es7262zujj8vl9o5.remove(platform.body, $_9v3uln10tjj8vl9un.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_51hhlz15gjj8vlb9d = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_9v3uln10tjj8vl9un.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_9v3uln10tjj8vl9un.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_43fkqu16ajj8vlbio = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_6rh4ykynjj8vl9fi.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_bzt3vi116jj8vl9wy.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_43fkqu16ajj8vlbio.sketch(onTap, mobile.translate));
    ...
    $_6i0cfymjj8vl9fg.append(mobile.container, mask.element());
    var mode = $_51hhlz15gjj8vlb9d.create(mobile, maskApi);
    return {
  ...
  var $_9ao8du15fjj8vlb8x = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_9v3uln10tjj8vl9un.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_fyncaazwjj8vl9o8.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_fyncaazwjj8vl9o8.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_27i1sj15cjj8vlb8b.bind(scope, 'touchmove', function (event) {
      $_4whnay11bjj8vl9xr.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_3pet3516ijj8vlbm9 = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_bzt3vi116jj8vl9wy.set(component.element(), 'overflow-x', 'auto');
              $_3pet3516ijj8vlbm9.markAsHorizontal(component.element());
              $_2a3r8v159jj8vlb7h.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_9v3uln10tjj8vl9un.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_9v3uln10tjj8vl9un.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_9v3uln10tjj8vl9un.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_9v3uln10tjj8vl9un.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_f0u3g314mjj8vlazu.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_es7262zujj8vl9o5.remove(component.element(), slideConfig.openClass());
    $_es7262zujj8vl9o5.add(component.element(), slideConfig.closedClass());
    $_bzt3vi116jj8vl9wy.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_bzt3vi116jj8vl9wy.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_es7262zujj8vl9o5.remove(component.element(), slideConfig.closedClass());
    $_es7262zujj8vl9o5.add(component.element(), slideConfig.openClass());
    $_bzt3vi116jj8vl9wy.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_bzt3vi116jj8vl9wy.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_bzt3vi116jj8vl9wy.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_bzt3vi116jj8vl9wy.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_es7262zujj8vl9o5.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_es7262zujj8vl9o5.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_bzt3vi116jj8vl9wy.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_es7262zujj8vl9o5.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_es7262zujj8vl9o5.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_bzt3vi116jj8vl9wy.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_8ask0z130jj8vlah9.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_7vibco115jj8vl9wt.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_9v3uln10tjj8vl9un.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_9v3uln10tjj8vl9un.resolve('dropup-closed'),
          openClass: $_9v3uln10tjj8vl9un.resolve('dropup-open'),
          shrinkingClass: $_9v3uln10tjj8vl9un.resolve('dropup-shrinking'),
          growingClass: $_9v3uln10tjj8vl9un.resolve('dropup-growing'),
        ...
        $_35gghw10sjj8vl9uf.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_2r0q1xykjj8vl9fc.name(event$$1.target()));
  };
  var isFirefox = $_g9jqply3jj8vl9cq.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_27i1sj15cjj8vlb8b.capture(container, 'focus', handler);
    } else {
      return $_27i1sj15cjj8vlb8b.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_27i1sj15cjj8vlb8b.capture(container, 'blur', handler);
    } else {
      return $_27i1sj15cjj8vlb8b.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_g9jqply3jj8vl9cq.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_27i1sj15cjj8vlb8b.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_27i1sj15cjj8vlb8b.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_6rh4ykynjj8vl9fi.defaultView(container);
    var onWindowScroll = $_27i1sj15cjj8vlb8b.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_6rh4ykynjj8vl9fi.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_czo5v8103jj8vl9p6.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_6yidjdyhjj8vl9ep.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_6rh4ykynjj8vl9fi.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_8lkpsvytjj8vl9g6.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_bff2dw101jj8vl9ow.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_2r0q1xykjj8vl9fc.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_e498z7yzjj8vl9h2.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_9v3uln10tjj8vl9un.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_9v3uln10tjj8vl9un.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_9v3uln10tjj8vl9un.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_9v3uln10tjj8vl9un.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_9rmgg716jjj8vlbmp.makeEditSwitch(webapp);
    var socket = $_9rmgg716jjj8vlbmp.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_9ao8du15fjj8vlb8x.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_9rmgg716jjj8vlbmp.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_bzt3vi116jj8vl9wy.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_6i0cfymjj8vl9fg.append(parent, input);
    $_bff2dw101jj8vl9ow.focus(input);
    operation(input);
    $_e498z7yzjj8vl9h2.remove(input);
  };
  var $_cmfa5w173jj8vlbx1 = { input: input$1 };
  ...
  var $_dtizfq175jj8vlbxw = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_bff2dw101jj8vl9ow.active().each(function (active) {
      if (!$_8lkpsvytjj8vl9g6.eq(active, frame)) {
        $_bff2dw101jj8vl9ow.blur(active);
      }
    });
    cWin.focus();
    $_bff2dw101jj8vl9ow.focus(Element$$1.fromDom(cWin.document.body));
    $_dtizfq175jj8vlbxw.refresh(cWin);
  };
  var $_fzzoga174jj8vlbxl = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_fzzoga174jj8vlbxl.resume(cWin, frame);
    };
    var toReading = function () {
      $_cmfa5w173jj8vlbx1.input(outerBody, $_bff2dw101jj8vl9ow.blur);
    };
    var captureInput = $_27i1sj15cjj8vlb8b.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_2r0q1xykjj8vl9fc.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_7vibco115jj8vl9wt.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_27i1sj15cjj8vlb8b.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_8lkpsvytjj8vl9g6.eq(editorApi.html(), touchEvent.target()) || $_8lkpsvytjj8vl9g6.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_27i1sj15cjj8vlb8b.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_27i1sj15cjj8vlb8b.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_27i1sj15cjj8vlb8b.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_27i1sj15cjj8vlb8b.bind(toolstrip, 'touchmove', function () {
  ...
  var $_79ywfx176jj8vlby2 = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_es7262zujj8vl9o5.add(container, $_9v3uln10tjj8vl9un.resolve('unfocused-selections'));
    $_6i0cfymjj8vl9fg.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_27i1sj15cjj8vlb8b.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_fzzoga174jj8vlbxl.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_f0u3g314mjj8vlazu.add(span, [
        $_9v3uln10tjj8vl9un.resolve('layer-editor'),
        $_9v3uln10tjj8vl9un.resolve('unfocused-selection')
      ]);
      $_bzt3vi116jj8vl9wy.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_egs3mn15njj8vlbbu.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_e6jvk7z0jj8vl9h6.append(container, spans);
    };
    var clear = function () {
      $_e498z7yzjj8vl9h2.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_e498z7yzjj8vl9h2.remove(container);
    };
    var isActive = function () {
      return $_6rh4ykynjj8vl9fi.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_auk2vn17gjj8vlc2h = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_auk2vn17gjj8vlc2h.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_c2a1rq15bjj8vlb7w.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_6rh4ykynjj8vl9fi.owner(socket).dom().defaultView;
    var viewportHeight = $_7vibco115jj8vl9wt.get(socket) + $_7vibco115jj8vl9wt.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_7vibco115jj8vl9wt.get(socket) + $_7vibco115jj8vl9wt.get(dropup) - greenzoneHeight;
    $_bzt3vi116jj8vl9wy.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_2mskdj17fjj8vlc26 = {
  ...
  var yFixedData = 'data-' + $_9v3uln10tjj8vl9un.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_9v3uln10tjj8vl9un.resolve('y-property');
  var yScrollingData = 'data-' + $_9v3uln10tjj8vl9un.resolve('scrolling');
  var windowSizeData = 'data-' + $_9v3uln10tjj8vl9un.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_blxqtt15mjj8vlbbq.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_fyncaazwjj8vl9o8.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_blxqtt15mjj8vlbbq.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_fyncaazwjj8vl9o8.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_dxlxi9119jj8vl9xl.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_fyncaazwjj8vl9o8.get(toolbar, 'style');
    $_bzt3vi116jj8vl9wy.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_fyncaazwjj8vl9o8.set(toolbar, yFixedData, '0px');
    $_fyncaazwjj8vl9o8.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_fyncaazwjj8vl9o8.set(toolbar, 'style', oldToolbarStyle || '');
      $_fyncaazwjj8vl9o8.remove(toolbar, yFixedData);
      $_fyncaazwjj8vl9o8.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_fyncaazwjj8vl9o8.get(viewport, 'style');
    $_2a3r8v159jj8vlb7h.register(viewport);
    $_bzt3vi116jj8vl9wy.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_fyncaazwjj8vl9o8.set(viewport, yFixedData, toolbarHeight + 'px');
    $_fyncaazwjj8vl9o8.set(viewport, yScrollingData, 'true');
    $_fyncaazwjj8vl9o8.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_2a3r8v159jj8vlb7h.deregister(viewport);
      $_fyncaazwjj8vl9o8.set(viewport, 'style', oldViewportStyle || '');
      $_fyncaazwjj8vl9o8.remove(viewport, yFixedData);
      $_fyncaazwjj8vl9o8.remove(viewport, yScrollingData);
      $_fyncaazwjj8vl9o8.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_fyncaazwjj8vl9o8.get(dropup, 'style');
    $_bzt3vi116jj8vl9wy.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_fyncaazwjj8vl9o8.set(dropup, yFixedData, '0px');
    $_fyncaazwjj8vl9o8.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_fyncaazwjj8vl9o8.set(dropup, 'style', oldDropupStyle || '');
      $_fyncaazwjj8vl9o8.remove(dropup, yFixedData);
      $_fyncaazwjj8vl9o8.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_6rh4ykynjj8vl9fi.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_fyncaazwjj8vl9o8.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_6rh4ykynjj8vl9fi.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_7vibco115jj8vl9wt.get(toolbar);
    var dropupHeight = $_7vibco115jj8vl9wt.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_7vibco115jj8vl9wt.get(toolbar);
        var dropupHeight_1 = $_7vibco115jj8vl9wt.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_fyncaazwjj8vl9o8.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_bzt3vi116jj8vl9wy.set(viewport, 'height', newHeight + 'px');
        $_bzt3vi116jj8vl9wy.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_2mskdj17fjj8vlc26.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_fyncaazwjj8vl9o8.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_2mskdj17fjj8vlc26.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_foxo5a17ejj8vlc1e = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_9o0otv17djj8vlc17.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_9v3uln10tjj8vl9un.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_bzt3vi116jj8vl9wy.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_bzt3vi116jj8vl9wy.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_bzt3vi116jj8vl9wy.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_fyncaazwjj8vl9o8.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_blxqtt15mjj8vlbbq.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_fyncaazwjj8vl9o8.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_fyncaazwjj8vl9o8.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_bzt3vi116jj8vl9wy.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_foxo5a17ejj8vlc1e.getYFixedData(element) + 'px';
    $_bzt3vi116jj8vl9wy.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_6rh4ykynjj8vl9fi.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_2mskdj17fjj8vlc26.getGreenzone(socket, dropup);
    var refreshCursor = curry($_dtizfq175jj8vlbxw.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_378qj1179jj8vlc0i.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_378qj1179jj8vlc0i.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_9pkh4017ijj8vlc2z = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_bzt3vi116jj8vl9wy.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_bzt3vi116jj8vl9wy.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_378qj1179jj8vlc0i.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_bcp0jq17jjj8vlc34.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_27i1sj15cjj8vlb8b.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_bcp0jq17jjj8vlc34.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_foxo5a17ejj8vlc1e.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_6yidjdyhjj8vl9ep.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_c2a1rq15bjj8vlb7w.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_9pkh4017ijj8vlc2z.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_bzt3vi116jj8vl9wy.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_378qj1179jj8vlc0i.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_cmfa5w173jj8vlbx1.input($_6yidjdyhjj8vl9ep.body(), $_bff2dw101jj8vl9ow.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_76s67l177jj8vlbyn = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_4t4pcn167jj8vlbh2.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_bzt3vi116jj8vl9wy.getRaw(platform.socket, 'height'),
          iframeHeight: $_bzt3vi116jj8vl9wy.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_3pet3516ijj8vlbm9.exclusive(doc, '.' + $_2a3r8v159jj8vlb7h.scrollable()) });
        $_es7262zujj8vl9o5.add(platform.container, $_9v3uln10tjj8vl9un.resolve('fullscreen-maximized'));
        $_3ibzw9168jj8vlbhr.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_bzt3vi116jj8vl9wy.set(platform.socket, 'overflow', 'scroll');
        $_bzt3vi116jj8vl9wy.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_bff2dw101jj8vl9ow.focus(editorApi.body());
        ...
        iosApi.set($_76s67l177jj8vlbyn.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_g4u88172jj8vlbwk.stubborn,
        ...
        iosEvents.set($_79ywfx176jj8vlby2.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_bzt3vi116jj8vl9wy.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_bzt3vi116jj8vl9wy.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_es7262zujj8vl9o5.remove(platform.container, $_9v3uln10tjj8vl9un.resolve('fullscreen-maximized'));
      $_3ibzw9168jj8vlbhr.restoreStyles();
      $_2a3r8v159jj8vlb7h.deregister(platform.toolbar);
      $_bzt3vi116jj8vl9wy.remove(platform.socket, 'overflow');
      $_bzt3vi116jj8vl9wy.remove(platform.socket, '-webkit-overflow-scrolling');
      $_bff2dw101jj8vl9ow.blur(platform.editor.getFrame());
      $_4t4pcn167jj8vlbh2.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_9x2ium171jj8vlbvn = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_bzt3vi116jj8vl9wy.set(mobile.toolstrip, 'width', '100%');
    $_bzt3vi116jj8vl9wy.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_43fkqu16ajj8vlbio.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_9x2ium171jj8vlbvn.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_5hwgxl170jj8vlbv7 = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_9v3uln10tjj8vl9un.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_9rmgg716jjj8vlbmp.makeEditSwitch(webapp);
    var socket = $_9rmgg716jjj8vlbmp.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_5hwgxl170jj8vlbv7.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_cmliv517mjj8vlc3l = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_b5d1u4109jj8vl9q4.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_et9vt217pjj8vlc3y = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_cmliv517mjj8vlc3l.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_et9vt217pjj8vlc3y.fireSkinLoaded(editor));
      } else {
        $_et9vt217pjj8vlc3y.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_g9jqply3jj8vl9cq.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_6i0cfymjj8vl9fg.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_bff2dw101jj8vl9ow.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_c2a1rq15bjj8vlb7w.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_b5d1u4109jj8vl9q4.orientationChanged()], { width: $_c2a1rq15bjj8vlb7w.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9v3uln10tjj8vl9un.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_2r0q1xykjj8vl9fc.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_2r0q1xykjj8vl9fc.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_g81c68107jj8vl9pv.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9v3uln10tjj8vl9un.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_9v3uln10tjj8vl9un.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_b5d1u4109jj8vl9q4.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_ftme9310ujj8vl9uq.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_ftme9310ujj8vl9uq.forToolbar('readonly-back', function () {
        ...
        var features = $_z62y110ajj8vl9qa.setup(realm, editor);
        var items = $_z62y110ajj8vl9qa.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_fnqxzq17ojj8vlc3p.init(realm, editor);
      });
      return {
