...
var inlite = (function () {
    ...
    var toAbsolute = function (rect) {
      var vp = global$1.DOM.getViewPort();
      return {
        x: rect.x + vp.x,
        y: rect.y + vp.y,
        w: rect.w,
    ...
    var fromContextToolbars = function (toolbars) {
      return global$3.map(toolbars, function (toolbar) {
    ...
    var calcByPositions = function (testPositions1, testPositions2, targetRect, contentAreaRect, panelRect) {
      ...
      relPos = global$5.findBestRelativePosition(panelRect, targetRect, paddedContentRect, testPositions1);
      targetRect = global$5.clamp(targetRect, paddedContentRect);
      if (relPos) {
        relRect = global$5.relativePosition(panelRect, targetRect, relPos);
        outputPanelRect = moveTo(panelRect, relRect);
        return result$1(outputPanelRect, relPos);
      }
      targetRect = global$5.intersect(paddedContentRect, targetRect);
      if (targetRect) {
        relPos = global$5.findBestRelativePosition(panelRect, targetRect, paddedContentRect, testPositions2);
        if (relPos) {
          relRect = global$5.relativePosition(panelRect, targetRect, relPos);
          outputPanelRect = moveTo(panelRect, relRect);
          return result$1(outputPanelRect, relPos);
    ...
    var urlFromName = function (name) {
      var prefix = global$4.baseURL + '/skins/';
    ...
    var load = function (editor, callback) {
      ...
      if (Settings.isSkinDisabled(editor)) {
        ...
        global$1.DOM.styleSheetLoader.load(skinUrl + '/skin.min.css', done);
    ...
    var bindContextualToolbarsEvents = function (editor, panel) {
      var throttledTogglePanel = global$2.throttle(togglePanel(editor, panel), 0);
      var throttledTogglePanelWhenNotInForm = global$2.throttle(ignoreWhenFormIsVisible(editor, panel, togglePanel(editor, panel)), 0);
      ...
      global$1.DOM.bind(editor.settings.ui_container, 'scroll', reposition);
      editor.on('remove', function () {
        global$1.DOM.unbind(editor.settings.ui_container, 'scroll', reposition);
        panel.remove();
      });
    ...
    var funcs = {
      ...
      create: function (name$$1, attrs, children) {
        ...
        global$1.DOM.setAttribs(elm, attrs);
        if (typeof children === 'string') {
          elm.innerHTML = children;
        } else {
          global$3.each(children, function (child) {
            if (child.nodeType) {
      ...
      createFragment: function (html) {
        return global$1.DOM.createFragment(html);
      },
      getWindowSize: function () {
        return global$1.DOM.getViewPort();
      },
      ...
      getPos: function (elm, root) {
        return global$1.DOM.getPos(elm, root || funcs.getContainer());
      },
      getContainer: function () {
        return global$6.container ? global$6.container : document.body;
      },
      getViewPort: function (win) {
        return global$1.DOM.getViewPort(win);
      },
      get: function (id) {
        return document.getElementById(id);
      },
      addClass: function (elm, cls) {
        return global$1.DOM.addClass(elm, cls);
      },
      removeClass: function (elm, cls) {
        return global$1.DOM.removeClass(elm, cls);
      },
      hasClass: function (elm, cls) {
        return global$1.DOM.hasClass(elm, cls);
      },
      toggleClass: function (elm, cls, state) {
        return global$1.DOM.toggleClass(elm, cls, state);
      },
      css: function (elm, name$$1, value) {
        return global$1.DOM.setStyle(elm, name$$1, value);
      },
      getRuntimeStyle: function (elm, name$$1) {
        return global$1.DOM.getStyle(elm, name$$1, true);
      },
      on: function (target, name$$1, callback, scope) {
        return global$1.DOM.bind(target, name$$1, callback, scope);
      },
      off: function (target, name$$1, callback) {
        return global$1.DOM.unbind(target, name$$1, callback);
      },
      fire: function (target, name$$1, args) {
        return global$1.DOM.fire(target, name$$1, args);
      },
      innerHtml: function (elm, html) {
        global$1.DOM.setHTML(elm, html);
      }
    };
    ...
    global$3.extend(ClassList.prototype, {
      add: function (cls) {
    ...
    proto = {
      ...
      each: function (callback) {
        global$3.each(this, callback);
        return this;
      },
      toArray: function () {
        return global$3.toArray(this);
      },
      ...
      reverse: function () {
        return new Collection$1(global$3.toArray(this).reverse());
      },
      ...
      exec: function (name) {
        var self = this, args = global$3.toArray(arguments).slice(1);
        self.each(function (item) {
          if (item[name]) {
    ...
    global$3.each('fire on off show hide append prepend before after reflow'.split(' '), function (name) {
      proto[name] = function () {
        var args = global$3.toArray(arguments);
    ...
    global$3.each('text name disabled active selected checked visible parent value data'.split(' '), function (name) {
    ...
    var setUiContainer = function (editor, ctrl) {
      var uiContainer = global$1.DOM.select(editor.settings.ui_container)[0];
    ...
    var proto$1 = {
      ...
      init: function (settings) {
        ...
        self$$1.settings = settings = global$3.extend({}, self$$1.Defaults, settings);
        ...
        global$3.each('title text name visible disabled active value'.split(' '), function (name$$1) {
    ...
    global$3.each('text title visible disabled active value'.split(' '), function (name$$1) {
    ...
    function calculateRelativePosition(ctrl, targetElm, rel) {
      ...
      var rootElm = ctrl.getRoot().modal ? ctrl.getRoot().getEl() : UiContainer.getUiContainer(ctrl);
    ...
    function NotificationManagerImpl (editor) {
      ...
      var open = function (args, closeCallback) {
        var extendedArgs = global$3.extend(args, { maxWidth: getContainerWidth() });
    ...
    var Container = Control$1.extend({
      ...
      create: function (items) {
        ...
        global$3.each(items, function (item) {
          if (item) {
            if (!(item instanceof Control$1)) {
              if (typeof item === 'string') {
                item = { type: item };
              }
              settings = global$3.extend({}, self.settings.defaults, item);
    ...
    function toggleFullScreenState(state) {
      ...
      if (global$6.overrideViewPort === false) {
        return;
      }
      if (!viewport) {
          ...
          global$7(window).on('resize', function () {
            ...
            if (self$$1._fullscreen) {
              if (!slowRendering) {
                ...
                if (!self$$1._timer) {
                  self$$1._timer = global$2.setTimeout(function () {
                    var rect = funcs.getWindowSize();
                    self$$1.moveTo(0, 0).resizeTo(rect.w, rect.h);
                    self$$1._timer = 0;
                  }, 50);
    ...
    var unwrapElements = function (editor, elms) {
      ...
      global$3.each(elms, function (elm) {
    ...
    var getSelectedAnchors = function (editor) {
      ...
      anchorElms = global$3.grep(getSelectedElements(rootElm, startElm, endElm), isLink);
      return anchorElms;
    };
    ...
    var createForm = function (name, spec) {
      var form = global$b.create(global$3.extend({
        type: 'form',
        layout: 'flex',
        direction: 'row',
        padding: 5,
    ...
    var create$2 = function (editor, name, items) {
      ...
      global$3.each(itemsToArray$1(items), function (item) {
        if (item === '|') {
          buttonGroup = null;
        } else {
    ...
    var create$3 = function () {
      ...
      var create = function (editor, toolbars) {
        ...
        return global$b.create({
          ...
          fixed: true,
          border: 1,
          items: global$3.grep(items, hasToolbarItems),
          oncancel: function () {
            editor.focus();
          }
        });
      ...
      var repositionPanelAt = function (panel, id, editor, targetRect) {
        ...
        panelRect = global$1.DOM.getRect(panel.getEl());
        if (id === 'insert') {
    ...
    var Layout$1 = global$8.extend({
      ...
      init: function (settings) {
        this.settings = global$3.extend({}, this.Defaults, settings);
      },
    ...
    var DropZone = Widget.extend({
      ...
      postRender: function () {
        ...
        var filter = function (files) {
          ...
          return global$3.grep(files, function (file) {
    ...
    var Form = Container.extend({
      ...
      preRender: function () {
        ...
        items.each(function (ctrl) {
          ...
          if (label) {
            formItem = new FormItem(global$3.extend({
              items: {
                type: 'label',
                id: ctrl._id + '-l',
                text: label,
    ...
    var getActiveEditor = function () {
      return window.tinymce ? window.tinymce.activeEditor : global$4.activeEditor;
    };
    var history = {};
    ...
    var toMenuItems = function (targets) {
      return global$3.map(targets, toMenuItem);
    };
    ...
    var createMenuItems = function (term, targets, fileType, editorSettings) {
      ...
      var fromHistoryMenuItems = function (history) {
        ...
        return global$3.map(uniqueHistory, function (url) {
          return {
            title: url,
            value: {
              title: url,
    ...
    var filterByQuery = function (term, menuItems) {
      ...
      var result = global$3.grep(menuItems, function (item) {
    ...
    var FilePicker = ComboBox.extend({
      ...
      init: function (settings) {
        ...
        if (fileBrowserCallbackTypes) {
          fileBrowserCallbackTypes = global$3.makeMap(fileBrowserCallbackTypes, /[, ]/);
        }
        if (!fileBrowserCallbackTypes || fileBrowserCallbackTypes[fileType]) {
          ...
          if (fileBrowserCallback && (!fileBrowserCallbackTypes || fileBrowserCallbackTypes[fileType])) {
            actionCallback = function () {
              ...
              meta = global$3.extend({ filetype: fileType }, meta);
    ...
    var register = function (editor) {
      ...
      editor.addButton('align', {
        ...
        onShowMenu: function (e) {
          ...
          global$3.each(alignFormats, function (formatName, idx) {
    ...
    var getFontItems = function (editor) {
      ...
      return global$3.map(fonts, function (font) {
        return {
          text: { raw: font[0] },
          value: font[1],
    ...
    var getFontSizeItems = function (editor) {
      ...
      return global$3.map(fontsizeFormats.split(' '), function (item) {
    ...
    var hideMenuObjects = function (editor, menu) {
      ...
      global$3.each(menu, function (item) {
        if (item.menu) {
    ...
    var createFormatMenu = function (editor) {
      ...
      var createMenu = function (formats) {
        ...
        global$3.each(formats, function (format) {
          var menuItem = {
            text: format.title,
            icon: format.icon
          };
      ...
      editor.on('init', function () {
        global$3.each(newFormats, function (format) {
    ...
    var createListBoxChangeHandler = function (editor, items, formatName) {
      return function () {
        ...
        editor.on('nodeChange', function (e) {
          ...
          var value = null;
          global$3.each(e.parents, function (node) {
            global$3.each(items, function (item) {
              if (formatName) {
    ...
    var lazyFormatSelectBoxItems = function (editor, blocks) {
      return function () {
        var items = [];
        global$3.each(blocks, function (block) {
          items.push({
            text: block[0],
            value: block[1],
            textStyle: function () {
    ...
    var buildMenuItems = function (editor, blocks) {
      return global$3.map(blocks, function (block) {
        return {
          text: block[0],
    ...
    var createCustomMenuItems = function (editor, names) {
      ...
      } else if (global$3.isArray(names)) {
        return flatten$1(global$3.map(names, function (names) {
          return createCustomMenuItems(editor, names);
        }));
      }
      items = global$3.grep(nameList, function (name) {
        return name === '|' || name in editor.menuItems;
      });
      return global$3.map(items, function (name) {
    ...
    var createContextMenuItems = function (editor, context) {
      ...
      var menuItems = global$3.grep(editor.menuItems, function (menuItem) {
        return menuItem.context === context;
      });
      global$3.each(menuItems, function (menuItem) {
    ...
    var setupEnvironment = function () {
      Widget.tooltips = !global$6.iOS;
      Control$1.translate = function (text) {
        return global$4.translate(text);
      };
    };
    var setupUiContainer = function (editor) {
      if (editor.settings.ui_container) {
        global$6.container = descendant$1(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
          return elm.dom();
        });
      }
    };
      ...
      showMenu: function (toggle) {
        ...
        if (!self$$1.menu) {
          ...
          if (!menu.renderTo) {
            ...
            self$$1.menu = global$b.create(menu).parent(self$$1).renderTo(elm);
          } else {
    ...
    function Throbber (elm, inline) {
      ...
      self.show = function (time, callback) {
        ...
        state = true;
        if (time) {
          timer = global$2.setTimeout(render, time);
        } else {
          render();
        }
        return self;
    ...
    var Menu = FloatPanel.extend({
      ...
      init: function (settings) {
        ...
        if (settings.itemDefaults) {
          ...
          var i = items.length;
          while (i--) {
            items[i] = global$3.extend({}, settings.itemDefaults, items[i]);
          }
        }
        self._super(settings);
        self.classes.add('menu');
        if (settings.animate && global$6.ie !== 11) {
    ...
    var appendTo = function (target) {
      if (target.ui) {
        global$3.each(getApi(), function (ref, key) {
          target.ui[key] = ref;
        });
      } else {
        target.ui = getApi();
