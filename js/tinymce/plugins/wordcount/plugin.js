...
var wordcount = (function () {
  ...
  var $_4qnvvdsrjgyjyaum = {
    each: each,
    map: map
  };

  var SETS$1 = $_ek4wn8spjgyjyau4.SETS;
  var OTHER = $_ek4wn8spjgyjyau4.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_4qnvvdsrjgyjyaum.map(string.split(''), memoized);
  };
  var $_aj7ybusqjgyjyaug = { classify: classify };

  var ci = $_ek4wn8spjgyjyau4.characterIndices;
  ...
  var $_d1yrtvssjgyjyaur = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_ek4wn8spjgyjyau4.EMPTY_STRING;
  var WHITESPACE$1 = $_ek4wn8spjgyjyau4.WHITESPACE;
  var PUNCTUATION$1 = $_ek4wn8spjgyjyau4.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_aj7ybusqjgyjyaug.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_d1yrtvssjgyjyaur.isWordBoundary(map, i)) {
  ...
  var $_4ct20ysojgyjyatt = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_4ct20ysojgyjyatt.getWords(getTextContent(editor)).length;
  };
  var $_aaar8esnjgyjyatp = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_aaar8esnjgyjyatp.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_bzqut9smjgyjyatl = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_aaar8esnjgyjyatp.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_czwdnastjgyjyauz = { setup: setup };

  global.add('wordcount', function (editor) {
    $_czwdnastjgyjyauz.setup(editor);
    return $_bzqut9smjgyjyatl.get(editor);
  });
  function Plugin () {
  }
