...
var wordcount = (function () {
  ...
  var $_7qld9qtjjj8ux06t = {
    each: each,
    map: map
  };

  var SETS$1 = $_2g9j9uthjj8ux06l.SETS;
  var OTHER = $_2g9j9uthjj8ux06l.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_7qld9qtjjj8ux06t.map(string.split(''), memoized);
  };
  var $_5gglwftijj8ux06r = { classify: classify };

  var ci = $_2g9j9uthjj8ux06l.characterIndices;
  ...
  var $_bmlaurtkjj8ux06v = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_2g9j9uthjj8ux06l.EMPTY_STRING;
  var WHITESPACE$1 = $_2g9j9uthjj8ux06l.WHITESPACE;
  var PUNCTUATION$1 = $_2g9j9uthjj8ux06l.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_5gglwftijj8ux06r.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_bmlaurtkjj8ux06v.isWordBoundary(map, i)) {
  ...
  var $_2yd5hatgjj8ux06i = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_2yd5hatgjj8ux06i.getWords(getTextContent(editor)).length;
  };
  var $_fwureotfjj8ux06g = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_fwureotfjj8ux06g.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_3i9khitejj8ux06f = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_fwureotfjj8ux06g.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_c8dk4utljj8ux06x = { setup: setup };

  global.add('wordcount', function (editor) {
    $_c8dk4utljj8ux06x.setup(editor);
    return $_3i9khitejj8ux06f.get(editor);
  });
  function Plugin () {
  }
