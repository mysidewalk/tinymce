...
var wordcount = (function () {
  ...
  var $_exjml8sxjiwaaik4 = {
    each: each,
    map: map
  };

  var SETS$1 = $_1mr2qmsvjiwaaijy.SETS;
  var OTHER = $_1mr2qmsvjiwaaijy.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_exjml8sxjiwaaik4.map(string.split(''), memoized);
  };
  var $_3vf8g8swjiwaaik2 = { classify: classify };

  var ci = $_1mr2qmsvjiwaaijy.characterIndices;
  ...
  var $_ajfoe1syjiwaaik6 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_1mr2qmsvjiwaaijy.EMPTY_STRING;
  var WHITESPACE$1 = $_1mr2qmsvjiwaaijy.WHITESPACE;
  var PUNCTUATION$1 = $_1mr2qmsvjiwaaijy.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_3vf8g8swjiwaaik2.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_ajfoe1syjiwaaik6.isWordBoundary(map, i)) {
  ...
  var $_gbxtmksujiwaaiju = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_gbxtmksujiwaaiju.getWords(getTextContent(editor)).length;
  };
  var $_1md1s9stjiwaaijs = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_1md1s9stjiwaaijs.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_dngqdgssjiwaaijr = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_1md1s9stjiwaaijs.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_3p4rjaszjiwaaikc = { setup: setup };

  global.add('wordcount', function (editor) {
    $_3p4rjaszjiwaaikc.setup(editor);
    return $_dngqdgssjiwaaijr.get(editor);
  });
  function Plugin () {
  }
