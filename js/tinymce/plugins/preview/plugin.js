...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_alddqgisjgyjy2bv.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_alddqgisjgyjy2bv.getPreviewDialogWidth(editor);
    var dialogHeight = $_alddqgisjgyjy2bv.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_3q5seditjgyjy2bz.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_bdetoeiqjgyjy2bp = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_bdetoeiqjgyjy2bp.open(editor);
    });
  };
  var $_9jssxpipjgyjy2bl = { register: register };
  ...
  var $_cnbzozivjgyjy2c8 = { register: register$1 };

  global.add('preview', function (editor) {
    $_9jssxpipjgyjy2bl.register(editor);
    $_cnbzozivjgyjy2c8.register(editor);
  });
  function Plugin () {
  }
