...
var help = (function () {
  ...
  var never$1 = $_2vl2fbb4jgyjxxw9.never;
  var always$1 = $_2vl2fbb4jgyjxxw9.always;
  var none = function () {
    return NONE;
  };
  var NONE = function () {
    ...
    var me = {
      ...
      toString: $_2vl2fbb4jgyjxxw9.constant('none()')
    };
    if (Object.freeze)
      Object.freeze(me);
    return me;
  ...
  var from$1 = $_cg9zz5b5jgyjxxwo.isFunction(Array.from) ? Array.from : function (x) {
    return slice.call(x);
  };
  var $_f9u76wb2jgyjxxu7 = {
    map: map,
    each: each,
    eachr: eachr,
    partition: partition,
  ...
  var $_6xuwghb7jgyjxxx8 = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = $_f9u76wb2jgyjxxu7.map($_6xuwghb7jgyjxxx8.shortcuts, function (shortcut) {
  ...
  var $_7b1yhtb1jgyjxxta = { makeTab: makeTab };
  ...
  var removeLeading = function (str, prefix) {
    return startsWith(str, prefix) ? $_ef2mg6bcjgyjxy0j.removeFromStart(str, prefix.length) : str;
  };
  var removeTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? $_ef2mg6bcjgyjxy0j.removeFromEnd(str, prefix.length) : str;
  };
  var ensureLeading = function (str, prefix) {
    return startsWith(str, prefix) ? str : $_ef2mg6bcjgyjxy0j.addToStart(str, prefix);
  };
  var ensureTrailing = function (str, prefix) {
    return endsWith(str, prefix) ? str : $_ef2mg6bcjgyjxy0j.addToEnd(str, prefix);
  };
  var contains$1 = function (str, substr) {
    return str.indexOf(substr) !== -1;
  };
  var capitalize = function (str) {
    return $_6a6064bdjgyjxy0q.head(str).bind(function (head) {
      return $_6a6064bdjgyjxy0q.tail(str).map(function (tail) {
  ...
  var $_ce55nibejgyjxy15 = { urls: urls };

  var makeLink = $_2vl2fbb4jgyjxxw9.curry($_6efep3bbjgyjxxzt.supplant, '<a href="${url}" target="_blank" rel="noopener">${name}</a>');
  var maybeUrlize = function (editor, key) {
    return $_f9u76wb2jgyjxxu7.find($_ce55nibejgyjxy15.urls, function (x) {
      return x.key === key;
    }).fold(function () {
  ...
  var getPluginKeys = function (editor) {
    var keys = $_4hriehbajgyjxxzb.keys(editor.plugins);
    return editor.settings.forced_plugins === undefined ? keys : $_f9u76wb2jgyjxxu7.filter(keys, $_2vl2fbb4jgyjxxw9.not($_2vl2fbb4jgyjxxw9.curry($_f9u76wb2jgyjxxu7.contains, editor.settings.forced_plugins)));
  };
  var pluginLister = function (editor) {
    var pluginKeys = getPluginKeys(editor);
    var pluginLis = $_f9u76wb2jgyjxxu7.map(pluginKeys, function (key) {
  ...
  var $_925n4kb9jgyjxxxn = { makeTab: makeTab$1 };
  ...
  var $_3xbhu0bfjgyjxy1p = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_7b1yhtb1jgyjxxta.makeTab(),
          $_925n4kb9jgyjxxxn.makeTab(editor)
        ],
        buttons: $_3xbhu0bfjgyjxy1p.makeRow(),
  ...
  var $_6i12jab0jgyjxxt2 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_6i12jab0jgyjxxt2.open(editor, pluginUrl));
  };
  var $_4t21ydazjgyjxxsx = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_6i12jab0jgyjxxt2.open(editor, pluginUrl)
    });
  ...
  var $_alkdkubhjgyjxy22 = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_alkdkubhjgyjxy22.register(editor, pluginUrl);
    $_4t21ydazjgyjxxsx.register(editor, pluginUrl);
