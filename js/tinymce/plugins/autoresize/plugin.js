...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_ajz8793jj8vl32l.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_ajz8793jj8vl32l.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_ajz8793jj8vl32l.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_ajz8793jj8vl32l.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_ajz8793jj8vl32l.getAutoResizeBottomMargin(editor);
    ...
    if ($_ajz8793jj8vl32l.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_au6g5l90jj8vl32d.resize(editor, oldSize);
    });
  };
  var $_1z7iep8zjj8vl32a = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_1z7iep8zjj8vl32a.register(editor, oldSize);
      $_au6g5l90jj8vl32d.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
